            ...
            <div class="block-content">
                <div class="table-responsive">
                    <div class="form-group ">
                        <label for="textarea" class="control-label">Mã Secret API dùng để Request Lên Sever  ( Dùng để xác thực ai là người truy cập web )</label>
                        <input class="form-control" id="secret-key"  example-textarea-input  wrap ="off" rows="6" placeholder="Nhập key 2FA" onpaste="setTimeout( e => {get_code_2fa()},100)"></input>
                    </div>
                    <div class="form-group">
