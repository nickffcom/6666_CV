...
// public $UA = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36";
...
//     public function __construct($proxy,$pwd,$UserAgent)
//     {
//         $this->proxy=$proxy;
//         $this->pwd=$pwd;
//         if($UserAgent){
...
//             $this->location_cookie_file = storage_path('/tool/'.$rd);
//     }
